...
import { channelImage_api } from '../config/constants';
...
const VideoCard = ({info}) => {
  ...
  return (
    <div className='flex flex-col m-2 w-[312px] h-[300px] hover:bg-slate-200 rounded-lg dark:hover:bg-slate-600 shadow-md'>
        {/* Main Image - Thumbnail*/}
        <img className="rounded-tl-lg rounded-tr-lg mb-2" alt="thumbnail" src={thumbnails?.medium?.url}/>
